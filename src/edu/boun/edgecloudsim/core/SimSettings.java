...
public class SimSettings {
	...
	//Enumeration for AV directions: to be used to check the next posiion of the AV
	public static enum AV_DIRECTION {
		NORTH,
		SOUTH,
		WEST,
		EAST;
		public static AV_DIRECTION getRandomDirection() {
...
//	private int CORE_FOR_EDGE_VM;
//	private int MIPS_FOR_EDGE_VM;
//	private int RAM_FOR_EDGE_VM;
//	private int STORAGE_FOR_EDGE_VM;
	
	//Tasks parameters for our simulation
	
	private int MIN_TASK_VELOCITY;
	private int MAX_TASK_VELOCITY;
	private int MIN_TASK_BANDWIDTH_NEEDED;//Mbps unit in properties file
	private int MAX_TASK_BANDWIDTH_NEEDED;//Mbps unit in properties file
	private int MIN_TASK_CPU_NEEDED;
	private int MAX_TASK_CPU_NEEDED;
	private int MIN_TASK_RAM_NEEDED;
...
//			NUM_OF_EDGE_HOSTS=Integer.parseInt(prop.getProperty("number_of_host_on_edge_datacenter"));
//			NUM_OF_EDGE_VMS=Integer.parseInt(prop.getProperty("number_of_vm_on_edge_host"));
//			NUM_OF_PLACE_TYPES=Integer.parseInt(prop.getProperty("number_of_place_type"));
//			CORE_FOR_EDGE_VM=Integer.parseInt(prop.getProperty("core_for_edge_vm"));
//			MIPS_FOR_EDGE_VM=Integer.parseInt(prop.getProperty("mips_for_edge_vm"));
//			RAM_FOR_EDGE_VM=Integer.parseInt(prop.getProperty("ram_for_edge_vm"));
//			STORAGE_FOR_EDGE_VM=Integer.parseInt(prop.getProperty("storage_for_edge_vm"));
			
			MIN_TASK_VELOCITY=Integer.parseInt(prop.getProperty("min_task_velocity"));
			MAX_TASK_VELOCITY=Integer.parseInt(prop.getProperty("max_task_velocity"));
			MIN_TASK_BANDWIDTH_NEEDED=Integer.parseInt(prop.getProperty("min_task_bandwidth_needed"));
			MAX_TASK_BANDWIDTH_NEEDED=Integer.parseInt(prop.getProperty("max_task_bandwidth_needed"));
			MIN_TASK_CPU_NEEDED=Integer.parseInt(prop.getProperty("min_task_cpu_needed"));
			MAX_TASK_CPU_NEEDED=Integer.parseInt(prop.getProperty("max_task_cpu_needed"));
			MIN_TASK_RAM_NEEDED=Integer.parseInt(prop.getProperty("min_task_ram_needed"));
	...
	/**
	 * returns the minimum possible value of the task's velocity
	 */
	public int getMIN_TASK_VELOCITY() {
		return MIN_TASK_VELOCITY;
	}

	/**
	 * returns the maximum possible value of the task's velocity
	 */
	public int getMAX_TASK_VELOCITY() {
		return MAX_TASK_VELOCITY;
	}

	/**
	 * returns the minimum possible value of the task's bandwidth needed
	 */
	public int getMIN_TASK_BANDWIDTH_NEEDED() {
		return MIN_TASK_BANDWIDTH_NEEDED;
	}

	/**
	 * returns the maximum possible value of the task's bandwidth needed
	 */
	public int getMAX_TASK_BANDWIDTH_NEEDED() {
		return MAX_TASK_BANDWIDTH_NEEDED;
	}

	
	public int getMIN_TASK_CPU_NEEDED() {
		return MIN_TASK_CPU_NEEDED;
	}

	public int getMAX_TASK_CPU_NEEDED() {
		return MAX_TASK_CPU_NEEDED;
	}

	public int getMIN_TASK_RAM_NEEDED() {
		return MIN_TASK_RAM_NEEDED;
	}

	public int getMAX_TASK_RAM_NEEDED() {
		return MAX_TASK_RAM_NEEDED;
	}

	public int getMIN_TASK_STORAGE_NEEDED() {
		return MIN_TASK_STORAGE_NEEDED;
	}
